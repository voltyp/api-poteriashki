...
export class AnimalsAndUsers1670096038631 implements MigrationInterface {
    name = 'AnimalsAndUsers1670096038631'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "animal" ADD CONSTRAINT "FK_02a7eb4034be5e9d9718b1c649f" FOREIGN KEY ("curatorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "animal" DROP CONSTRAINT "FK_02a7eb4034be5e9d9718b1c649f"`);
